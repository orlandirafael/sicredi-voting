package br.com.sicredi.gateway.config;
...
public class ZuulConfiguration {
  ...
  /**
   * The path returned by ErrorContoller.getErrorPath() with Spring Boot < 2.5 (and no longer
  ...
  private static final class ZuulPostProcessor implements BeanPostProcessor {
    ...
    ZuulPostProcessor(
        RouteLocator routeLocator, ZuulController zuulController, ErrorController errorController) {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName)
      ...
      if (hasErrorController && (bean instanceof ZuulHandlerMapping)) {
        ...
        return enhancer.create(
            ctor.getParameterTypes(), new Object[] {routeLocator, zuulController});
      }
      return bean;
    }
  }
